...
private:
    ...
    static float _ReadAmount()
    {
        ...
        Amount = clsInputVailddate::ReadFloatNumber();
        return Amount;
    }
    ...
    static clsCurrency _GetCurrency(string Message)
    {
        ...
        CurrencyCode = clsInputVailddate::ReadString();

        while (!clsCurrency::IsCurrencyExists(CurrencyCode))
        {
            cout << "\nCurrency is not found, choose another one: ";
            CurrencyCode = clsInputVailddate::ReadFloatNumber();
        }
...
public:
    ...
    static void ShowCurrencyCalculatorScreen()
    {
        ...
        while (Continue == 'y' || Continue == 'Y')
        {
            ...
            _DrawScreenHeader("\tCalcultor Currency Screen");
